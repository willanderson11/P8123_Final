...
svyhist(~bp_sys_mean, htsub2, main = "Average Systolic Blood Pressure NHANES 2013-2020", xlab = "Average Systolic Blood Pressure (mmHg)")
...
svyplot(bp_sys_mean~demo_age_years, htsub2, style = "transparent", xlab = "Age (years)", ylab = "Average Systolic Blood Pressure (mmHg)", main = "Survey-Weighted Bubble Plot")
...
svyboxplot(bp_sys_mean~factor(cc_smoke), htsub2, na.rm=TRUE, xlab = "Smoking Status", ylab = "Average Systolic Blood Pressure (mmHg)", main = "Systolic Blood Pressure per Smoking Status")
